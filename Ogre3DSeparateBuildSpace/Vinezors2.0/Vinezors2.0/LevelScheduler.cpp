...
//        cout << "Difficulty: " << difficulty << endl;
        ...
        if (holdout)
            node.first.generateStageRequest(nBackRounded, phase, difficulty, currentHoldout, currentUNL);
        else
            node.first.generateStageRequest(nBackRounded, phase, difficulty, 0.0, currentUNL);
