...
: currentColor(baseColor), baseColor(baseColor), blinkColor(blinkColor), timeBlinkLength(blinktime), timeBlinked(0), ontime(blinktime), offtime(0), toggle(false), timeToggle(0)
{
}

Blinkable::Blinkable(Color baseColor, Color blinkColor, Number blinktime, Number ontime, Number offtime)
    : currentColor(baseColor), baseColor(baseColor), blinkColor(blinkColor), timeBlinkLength(blinktime), timeBlinked(0), ontime(ontime), offtime(offtime), toggle(false), timeToggle(0)
{
}
