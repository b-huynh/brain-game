...
// If more colors, shapes, sounds added, include between unknown and holdout for they are the boundaries are used for iteration!!
enum PodColor { POD_COLOR_UNKNOWN, POD_COLOR_BLUE, POD_COLOR_GREEN, POD_COLOR_PINK, POD_COLOR_YELLOW, POD_COLOR_PURPLE, POD_COLOR_HOLDOUT };
enum PodSound { POD_SOUND_UNKNOWN, POD_SOUND_1, POD_SOUND_2, POD_SOUND_3, POD_SOUND_4, POD_SOUND_HOLDOUT };
enum PodShape { POD_SHAPE_UNKNOWN, POD_SHAPE_DIAMOND, POD_SHAPE_SPHERE, POD_SHAPE_CONE, POD_SHAPE_TRIANGLE, POD_SHAPE_HOLDOUT  }; // POD_CYLINDER, POD_BOX
