...
{
private:
    float mushroomGummyAnimationTimer;
    ...
    float flowerHitWobbleSpeed;
    bool retractAnimationFlag;
    float retractAnimationTimer;
...
public:
    ...
    void assertRetractAnimationFlag();
    void desertRetractAnimationFlag();
