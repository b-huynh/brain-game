...
#ifndef __VinezorsiOS__EngineInformation__
#define __VinezorsiOS__EngineInformation__
...
class EngineInformation : public Engine
{
public:
    EngineInformation(EngineStateManager* engineStateMgr, Player* player);
    virtual ~EngineInformation();
...
#endif /* defined(__VinezorsiOS__EngineInformation__) */
