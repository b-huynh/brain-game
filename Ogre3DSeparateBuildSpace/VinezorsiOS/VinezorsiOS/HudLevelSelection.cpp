...
void HudLevelSelection::setOverlay()
{
    ...
    if (player->levelCompletion[0] > 0)
        levelA1Background->setMaterialName("General/PauseButtonYellow");
    else
        levelA1Background->setMaterialName("General/PauseButton");
    if (player->levelCompletion[1] > 0)
        levelA2Background->setMaterialName("General/PauseButtonYellow");
    else
        levelA2Background->setMaterialName("General/PauseButton");
    if (player->levelCompletion[2] > 0)
        levelA3Background->setMaterialName("General/PauseButtonYellow");
    else
        levelA3Background->setMaterialName("General/PauseButton");
    if (player->levelCompletion[3] > 0)
        levelA4Background->setMaterialName("General/PauseButtonYellow");
    else
        levelA4Background->setMaterialName("General/PauseButton");
    if (player->levelCompletion[4] > 0)
        levelA5Background->setMaterialName("General/PauseButtonYellow");
    else
        levelA5Background->setMaterialName("General/PauseButton");
    if (player->levelCompletion[5] > 0)
        levelA6Background->setMaterialName("General/PauseButtonYellow");
    else
        levelA6Background->setMaterialName("General/PauseButton");
    if (player->levelCompletion[6] > 0)
        levelA7Background->setMaterialName("General/PauseButtonYellow");
    else
        levelA7Background->setMaterialName("General/PauseButton");
    
    
    if (player->levelCompletion[0] > 0)
        levelB1Background->setMaterialName("General/PauseButtonYellow");
    else
        levelB1Background->setMaterialName("General/PauseButton");
    if (player->levelCompletion[1] > 0)
        levelB2Background->setMaterialName("General/PauseButtonYellow");
    else
        levelB2Background->setMaterialName("General/PauseButton");
    if (player->levelCompletion[2] > 0)
        levelB3Background->setMaterialName("General/PauseButtonYellow");
    else
        levelB3Background->setMaterialName("General/PauseButton");
    if (player->levelCompletion[3] > 0)
        levelB4Background->setMaterialName("General/PauseButtonYellow");
    else
        levelB4Background->setMaterialName("General/PauseButton");
    if (player->levelCompletion[4] > 0)
        levelB5Background->setMaterialName("General/PauseButtonYellow");
    else
        levelB5Background->setMaterialName("General/PauseButton");
    if (player->levelCompletion[5] > 0)
        levelB6Background->setMaterialName("General/PauseButtonYellow");
    else
        levelB6Background->setMaterialName("General/PauseButton");
    if (player->levelCompletion[6] > 0)
        levelB7Background->setMaterialName("General/PauseButtonYellow");
    else
        levelB7Background->setMaterialName("General/PauseButton");
