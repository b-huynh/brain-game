...
float LevelManager::extractTotalTime() const
{
    ...
    */
    float speedTrialLength = globals.timeTrialLengthMin;
    if (player->getSkillLevel().sessionID >= 1)
        speedTrialLength += ((globals.timeTrialLengthMax - globals.timeTrialLengthMin) / globals.expectedNumSessions) * (player->getSkillLevel().sessionID - 1);
...
Tunnel* LevelManager::getNextLevel(Tunnel* previousTunnel)
{
    ...
    switch (getCurrentPhase())
    {
        case PHASE_SET1:
        {
            ...
            globals.signalTypes[POD_SIGNAL_2].push_back(PodInfo(POD_SIGNAL_2, POD_FLOWER, POD_COLOR_BLUE, POD_SHAPE_UNKNOWN, POD_SOUND_2));
            globals.signalTypes[POD_SIGNAL_3].push_back(PodInfo(POD_SIGNAL_3, POD_FLOWER, POD_COLOR_PINK, POD_SHAPE_UNKNOWN, POD_SOUND_1));
            globals.signalTypes[POD_SIGNAL_4].push_back(PodInfo(POD_SIGNAL_4, POD_FLOWER, POD_COLOR_YELLOW, POD_SHAPE_UNKNOWN, POD_SOUND_4));
        ...
        case PHASE_SET2:
        {
            ...
            globals.signalTypes[POD_SIGNAL_2].push_back(PodInfo(POD_SIGNAL_2, POD_FLOWER, POD_COLOR_ORANGE, POD_SHAPE_IRIS, POD_SOUND_2));
            globals.signalTypes[POD_SIGNAL_3].push_back(PodInfo(POD_SIGNAL_3, POD_FLOWER, POD_COLOR_ORANGE, POD_SHAPE_BUBBLE, POD_SOUND_3));
            globals.signalTypes[POD_SIGNAL_4].push_back(PodInfo(POD_SIGNAL_4, POD_FLOWER, POD_COLOR_ORANGE, POD_SHAPE_DAISY, POD_SOUND_4));
        ...
        case PHASE_SET3:
        {
            ...
            globals.signalTypes[POD_SIGNAL_2].push_back(PodInfo(POD_SIGNAL_2, POD_FLOWER, POD_COLOR_UNKNOWN, POD_SHAPE_UNKNOWN, POD_SOUND_2));
            globals.signalTypes[POD_SIGNAL_3].push_back(PodInfo(POD_SIGNAL_3, POD_FLOWER, POD_COLOR_UNKNOWN, POD_SHAPE_UNKNOWN, POD_SOUND_3));
            globals.signalTypes[POD_SIGNAL_4].push_back(PodInfo(POD_SIGNAL_4, POD_FLOWER, POD_COLOR_UNKNOWN, POD_SHAPE_UNKNOWN, POD_SOUND_4));
        ...
        case PHASE_NAVIGATION:
        {
            ...
            globals.setMessage("Avoid Obstacles. Grab Flowers!", MESSAGE_NORMAL);
            break;
        }
        case PHASE_TIMED:
        {
            ...
            globals.signalTypes[POD_SIGNAL_2].push_back(PodInfo(POD_SIGNAL_2, POD_FLOWER, POD_COLOR_BLUE, POD_SHAPE_IRIS, POD_SOUND_2));
            globals.signalTypes[POD_SIGNAL_3].push_back(PodInfo(POD_SIGNAL_3, POD_FLOWER, POD_COLOR_GREEN, POD_SHAPE_BUBBLE, POD_SOUND_3));
            globals.signalTypes[POD_SIGNAL_4].push_back(PodInfo(POD_SIGNAL_4, POD_FLOWER, POD_COLOR_YELLOW, POD_SHAPE_DAISY, POD_SOUND_4));
            
            std::cout << "Navigation Upgrade Num: " << globals.tunnelSectionsPerNavigationUpgrade << std::endl;
            
            globals.setBigMessage(Util::toStringInt(nlevel) + "-Back");
            globals.setMessage("Grab Matching Flowers!", MESSAGE_NORMAL);
            break;
        }
        case PHASE_TEACHING:
        {
            ...
            globals.setMessage("Move to Grab Flowers!", MESSAGE_NORMAL);
            break;
        }
        case PHASE_RECESS:
        {
