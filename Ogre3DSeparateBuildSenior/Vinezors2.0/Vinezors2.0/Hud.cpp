...
void Hud::setOverlay()
{
    ...
    label1->setColour(ColourValue::ColourValue(0.0, 0.0, 0.0));
    ...
    label2->setColour(ColourValue::ColourValue(0.0, 0.0, 0.0));
    ...
    label3->setColour(ColourValue::ColourValue(0.0, 0.0, 0.0));
    ...
    label4->setColour(ColourValue::ColourValue(0.0, 0.0, 0.0));
    ...
    label5->setColour(ColourValue::ColourValue(0.0, 0.0, 0.0));
    ...
    label6->setColour(ColourValue::ColourValue(0.0, 0.0, 0.0));
    ...
    label7->setColour(ColourValue::ColourValue(0.0, 0.0, 0.0));
...
void Hud::update(float elapsed)
{
    ...
    {
        Ogre::ColourValue fontColor = timeLeft <= 0.0 ? ColourValue(1.0, 0.0, 0.0) : ColourValue(0.0, 0.0, 0.0);
        label2->setColour(fontColor);
        label2->setCaption("Time: " + Util::toStringInt(timeLeft));
    }
    else if (tunnel->getMode() == GAME_NAVIGATION)
    {
        Ogre::ColourValue fontColor = player->getHP() <= globals.HPNegativeLimit ? Ogre::ColourValue(1.0, 0.0, 0.0) : Ogre::ColourValue(0.0, 0.0, 0.0);
        label2->setColour(fontColor);
    ...
    {
        float percentComplete = static_cast<float>(tunnel->getTotalElapsed()) / globals.stageTime * 100;
        percentComplete = Util::clamp(percentComplete, 0.0, 100.0);
        label5->setCaption("Completed: " + Util::toStringInt(percentComplete) + "%");
    }
    else
