...
enum PodColor { POD_COLOR_BLUE, POD_COLOR_GREEN, POD_COLOR_PINK, POD_COLOR_YELLOW, POD_COLOR_ORANGE, POD_COLOR_UNKNOWN };
enum PodSound { POD_SOUND_1, POD_SOUND_2, POD_SOUND_3, POD_SOUND_4, POD_SOUND_UNKNOWN };
enum PodShape { POD_SHAPE_SPHERE, POD_SHAPE_TRIANGLE, POD_SHAPE_DIAMOND, POD_SHAPE_CONE, POD_SHAPE_UNKNOWN,
                POD_SHAPE_ROSE, POD_SHAPE_IRIS, POD_SHAPE_BUBBLE, POD_SHAPE_DAISY }; // POD_CYLINDER, POD_BOX
...
// Vine Info
enum VineMeshType { VINE_BASIC_SHIP, VINE_RUNNER_SHIP, VINE_FLOWER_SHIP, VINE_BEE };
...
namespace Util
{
    static const float EPSILON = 0.0010f;
    ...
    void copySides(bool dest[NUM_DIRECTIONS], bool src[NUM_DIRECTIONS]);
