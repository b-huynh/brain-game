...
enum EngineState { ENGINE_NONE, ENGINE_STAGE, ENGINE_SCHEDULER_MENU, ENGINE_LEVEL_SELECTION, ENGINE_MAIN_MENU, ENGINE_CREDITS, ENGINE_MAIN_SETTINGS, ENGINE_CONTROL_SETTINGS };
